            ...
            <tr>
                <td>
                    <p style="width: 80%; margin: 16px auto">
                        Seems like you haven't registered yet , click
                        <a href="{{route('web.get_register')}}" target="_blank" style="color: #63caf7; text-decoration: none">here</a>
                        to register on Sound&Tag , or click <a href="{{route('web.unsubscribe', ['t_user_id'=> $user_id, 't_user_email'=> $email])}}" target="_blank" style="color: #63caf7; text-decoration: none">here</a> to unsubscribe .
                    </p>
                </td>
            </tr>
