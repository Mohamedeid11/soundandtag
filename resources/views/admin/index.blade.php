...
@section('content')
    <div class="row">
        <div class="col-sm-6 col-lg-3">
            <div class="card text-center text-light" style="background: green">
                <div class="card-heading">
                    <h4 class="card-title text-light mb-0">{{__('admin.system_health')}}</h4>
                </div>
                <div class="card-body p-t-10">
                    <h2 class="m-t-0 m-b-15"><i class="mdi mdi-check text-success m-r-10"></i><b>{{__('admin.good')}}</b></h2>
                    <p class="text-light m-b-0 m-t-20">{{$health->get('message')}}</p>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
            <div class="card text-center">
                <div class="card-heading">
                    <h4 class="card-title text-muted mb-0">{{__('admin.total_users')}}</h4>
                </div>
                <div class="card-body p-t-10">
                    <h2 class="m-t-0 m-b-15"><i class="mdi mdi-account text-primary m-r-10"></i><b>{{$userStats->get('total')}}</b></h2>
                    <p class="text-muted m-b-0 m-t-20"><strong>{{$userStats->get('personal')}}</strong> {{__('global.personal')}} | <strong>{{$userStats->get('corporate')}}</strong>
                        {{__('global.corporate')}}</p>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
            <div class="card text-center">
                <div class="card-heading">
                    <h4 class="card-title text-muted mb-0">{{__('admin.registered_today')}}</h4>
                </div>
                <div class="card-body p-t-10">
                    <h2 class="m-t-0 m-b-15"><i class="mdi mdi-account text-primary m-r-10"></i><b>{{$userStats->get('today')->get('total')}}</b></h2>
                    <p class="text-muted m-b-0 m-t-20"><strong>{{$userStats->get('today')->get('personal')}}</strong> {{__('global.personal')}} | <strong>{{$userStats->get('today')->get('corporate')}}</strong>
                        {{__('global.corporate')}}</p>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
            <div class="card text-center">
                <div class="card-heading">
                    <h4 class="card-title text-muted mb-0">{{__('admin.registered_this_week')}}</h4>
                </div>
                <div class="card-body p-t-10">
                    <h2 class="m-t-0 m-b-15"><i class="mdi mdi-account text-primary m-r-10"></i><b>{{$userStats->get('week')->get('total')}}</b></h2>
                    <p class="text-muted m-b-0 m-t-20"><strong>{{$userStats->get('week')->get('personal')}}</strong> {{__('global.personal')}} | <strong>{{$userStats->get('week')->get('corporate')}}</strong>
                        {{__('global.corporate')}}</p>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
            <div class="card text-center">
                <div class="card-heading">
                    <h4 class="card-title text-muted mb-0">{{__('admin.registered_this_month')}}</h4>
                </div>
                <div class="card-body p-t-10">
                    <h2 class="m-t-0 m-b-15"><i class="mdi mdi-account text-primary m-r-10"></i><b>{{$userStats->get('month')->get('total')}}</b></h2>
                    <p class="text-muted m-b-0 m-t-20"><strong>{{$userStats->get('month')->get('personal')}}</strong> {{__('global.personal')}} | <strong>{{$userStats->get('month')->get('corporate')}}</strong>
                        {{__('global.corporate')}}</p>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
            <div class="card text-center">
                <div class="card-heading">
                    <h4 class="card-title text-muted mb-0">{{__('global.contact_messages')}}</h4>
                </div>
                <div class="card-body p-t-10">
                    <h2 class="m-t-0 m-b-15"><i class="mdi mdi-mailbox text-primary m-r-10"></i><b> {{$userStats->get('contact')}}</b></h2>
                    <p class="text-muted m-b-0 m-t-20"><strong>{{$userStats->get('contact')}}</strong> {{__('global.new')}} </p>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
            <div class="card text-center">
                <div class="card-heading">
                    <h4 class="card-title text-muted mb-0">{{__('admin.newsletter_subscriptions')}}</h4>
                </div>
                <div class="card-body p-t-10">
                    <h2 class="m-t-0 m-b-15"><i class="mdi mdi-email text-primary m-r-10"></i><b> {{$userStats->get('subscription')}}</b></h2>
                    <p class="text-muted m-b-0 m-t-20"><strong>{{$userStats->get('subscription')}}</strong> {{__('global.new')}}  </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card bg-light text-dark">
                <div class="card-header">
                    <h2 class="text-dark">{{__('admin.google_analytics')}}</h2>
                </div>
                <div class="card-body">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <header class="Titles">
                                    <h1 class="Titles-main">{{__('admin.week_vs_last')}}</h1>
                                    <div class="Titles-sub">{{__('admin.by_sessions')}}</div>
                                </header>
                            ...
                            <div class="col-12 col-md-6">
                                <header class="Titles">
                                    <h1 class="Titles-main">{{__('admin.year_vs_last')}}</h1>
                                    <div class="Titles-sub">{{__('admin.by_users')}}</div>
                                </header>
                            ...
                            <div class="col-12 col-md-6">
                                <header class="Titles">
                                    <h1 class="Titles-main">{{__('admin.top_browsers')}}</h1>
                                    <div class="Titles-sub">{{__('admin.by_page_view')}}</div>
                                </header>
                            ...
                            <div class="col-12 col-md-6">
                                <header class="Titles">
                                    <h1 class="Titles-main">{{__('admin.top_countries')}}</h1>
                                    <div class="Titles-sub">{{__('admin.by_sessions')}}</div>
                                </header>
    ...
    <script>
        ...
        gapi.analytics.ready(function() {
            ...
            gapi.analytics.auth.authorize({
                ...
                clientid: '330001833457-m6978npd33bqgcee5rl1gjoirkju1v1d.apps.googleusercontent.com'
            });
