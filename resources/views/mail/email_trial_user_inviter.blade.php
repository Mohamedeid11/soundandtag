...
<html lang="en">
    ...
    <body style="margin: 0;">
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="
            ...
            <tr>
                <td>
                    <p style="width: 80%; margin: 16px auto"> Your request pronunciations has been accepted , click the card below to visit his profile </p>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <a href="{{ route(
                        'web.getTryingUserProfile', ['user_id' => $invitee->id]
                    ) }}">
                        <img src="{{asset('storage/uploads/profile/card-'.$invitee->id.'.jpg')}}" style="width: 100%;">
                    </a>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <p style="color: #63caf7; margin-top: 4px; font-size: 13px">His profile card</p>
                </td>
            </tr>
