...
<body style="margin: 0;">
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="
        ...
        <tr>
            <td>
                <h3>
                    <span style="font-weight: 400; font-size: 16px">Dear {{$name}} , </span>
                </h3>
            </td>
        </tr>
        <tr>
            <td>
                <p style="width: 80%; margin: 16px auto">
                    Your corporate,
                    <a href="{{route('web.profile', ['username'=> $company_username ])}}" target="_blank" style="color: #63caf7; text-decoration: none">{{$company_name}}</a>
                    , invited you to join sound&tag,
                    <a href="{{$link}}" style="color: #63caf7; text-decoration: none">click here</a>
                    to register
                </p>
            </td>
        </tr>
