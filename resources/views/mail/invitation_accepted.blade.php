...
<html lang="en">
    ...
    <body style="margin: 0;">
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="
            ...
            <tr>
                <td>
                    <p style="width: 80%; margin: 16px auto"> A user you've invited has registered to use the platform </p>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <p style="width: 80%; margin: 16px auto">
                        The user email is : <a href="mailto:{{$user->email}}" target="_blank" style="color: #63caf7; text-decoration: none">{{$user->email}}</a>
                    </p>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <p style="width: 80%; margin: 16px auto">
                        When the user completes his profile you can access his pronunciation 
                        <a href="{{route('web.profile', ['username'=>$user->username])}}" target="_blank" style="color: #63caf7; text-decoration: none">here</a>
                    </p>
                </td>
            </tr>
