...
<html lang="en">
    ...
    <body style="margin: 0;">
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="
            ...
            @php
            $shareUrl = LaravelLocalization::getNonLocalizedURL(route('web.get_invite_link', ['username'=> $username]));
            @endphp
            ...
            <tr>
                <td>
                    <p style="width: 80%; margin: 16px auto">
                        ...
                        to record your names pronunciations, just click 
                        <a href="{{route('web.tryService',['username' => $username ])}}" style="color: #63caf7; text-decoration: none">here</a> 
                        and start recording.
                    </p>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <a href="{{route('web.profile', ['username'=> $username])}}">
                        <img src="{{asset('storage/uploads/profile/card-'.$username.'.jpg')}}" style="width: 100%;">
                    </a>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <p style="width: 80%; margin: 16px auto">
                        Your can also register from 
                        <a href="{{$shareUrl}}" target="_blank" style="color: #63caf7; text-decoration: none">here</a>.
                    </p>
                </td>
            </tr>
