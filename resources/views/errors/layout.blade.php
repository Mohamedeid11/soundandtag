...
<html lang="en">
    <head>
        ...
        <style>
            body {
                background: radial-gradient(circle, #031839 0%, #00101f 40%);
            }
            .page {
                height: 100vh;
                color: #fff
    ...
    <body>
        <div class="page w-100 position-relative overflow-hidden d-flex align-items-center justify-content-center flex-column">
