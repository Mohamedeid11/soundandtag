...
<div class="row row-list ">
    ...
    <div class="single_contact_form form-group col-6">
        <label for="first_name_meaning-input">{{__('global.first_name_meaning')}} <sup class="required"></sup></label>
...
<div class="row row-list ">
    ...
    <div class="single_contact_form form-group col-6">
        <label for="middle_name_meaning-input">{{__('global.middle_name_meaning')}} <sup class="required"></sup></label>
...
<div class="row row-list ">
    ...
    <div class="single_contact_form form-group col-6">
        ...
        <input type="text" name="last_name" id="last-name-input" required  class="form-control cu_input check_error @if(! $user->last_name) required_error @endif  @if($errors->has('last_name')) is-invalid @endif " placeholder="{{__('admin.placeholder_text', ['name'=>__('global.last_name')])}}" value="{{inp_value($user, 'last_name')}}">
    ...
    <div class="single_contact_form form-group col-6">
        <label for="last_name_meaning-input">{{__('global.last_name_meaning')}} <sup class="required"></sup></label>
...
<div class="row row-list ">
    ...
    <div class="single_contact_form form-group col-6">
        <label for="nick_name_meaning-input">{{__('global.nick_name_meaning')}} <sup class="required"></sup></label>
        <input type="text" name="nick_name_meaning" id="nick_name_meaning-input" class="form-control cu_input @if($errors->has('nick_name_meaning')) is-invalid @endif @if(! $errors->nick_name_meaning) @endif" placeholder="{{__('admin.placeholder_text', ['name'=>__('global.nick_name_meaning')])}}" value="{{inp_value_for_record($records['3']->record,'nick_name_meaning', 'meaning')}}">
...
<div class="row row-list ">
    ...
    <div class="single_contact_form form-group col-6">
        ...
        <select type="text" name="country_id" id="country-input" class="form-control cu_input @if(! $user->country_id) required_error @endif check_error @if($errors->has('country_id')) is-invalid @endif @if(! $user->country_id) @endif" required>
...
<div class="row row-list ">
    ...
    <div class="single_contact_form form-group col-6">
        <label for="company-input">{{__('global.company')}} <sup class="required"></sup></label>
        <input type="text" name="company" id="company-input" class="form-control cu_input @if($errors->has('company')) is-invalid @endif " placeholder="{{__('admin.placeholder_text', ['name'=>__('global.company')])}}" value="{{inp_value_for_record($records['4']->record,'company', 'text_representation')}}">
    ...
    <div class="single_contact_form form-group col-6">
        <label for="company_meaning-input">{{__('global.company_meaning')}} <sup class="required"></sup></label>
        <input type="text" name="company_meaning" id="company_meaning-input" class="form-control cu_input @if($errors->has('company_meaning')) is-invalid @endif @if(! $errors->company_meaning) @endif" placeholder="{{__('admin.placeholder_text', ['name'=>__('global.company_meaning')])}}" value="{{inp_value_for_record($records['4']->record,'company_meaning', 'meaning')}}">
        @if($errors->has('company_meaning'))
        <div class="invalid-feedback">
            @foreach($errors->get('company_meaning') as $error)
            <span>{{$error}}</span>
            @endforeach
        </div>
        @endif
...
<div class="row row-list ">
    ...
    <!--Postion Section -->
    <div class="single_contact_form form-group col-6">
        <label for="position-input">{{__('global.position')}}</label>
        <input type="text" name="position" id="position-input" class="form-control cu_input @if($errors->has('position')) is-invalid @endif" placeholder="{{__('admin.placeholder_text', ['name'=>__('global.position')])}}" value="{{inp_value($user, 'position')}}">
